...
Key Steps
1. Create a Resource Group in Azure 0:24
...
2. Create a Storage Account for the Website 1:11
...
o	If the name is already taken, add random numbers or a unique suffix.
•	Select Locally Redundant Storage (LRS).
•	Keep Standard Performance selected.
•	Click Review + Create, then Create.
•	Wait for deployment to complete.
3. Enable Static Website Hosting 2:24
...
4. Upload Website Files to the $web Container 3:17
...
5. Verify the Website Is Live 4:25
...
6. Clean Up Azure Resources to Avoid Charges 4:48
